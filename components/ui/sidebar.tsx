...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{t('ui.a11y.toggle_sidebar')}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      aria-label={t('ui.a11y.toggle_sidebar')}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t('ui.a11y.toggle_sidebar')}
      className={cn(
